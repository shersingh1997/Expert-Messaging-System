		...
		<div class="row">
			...
			<div class="col-lg-8 col-md-8 col-sm-6 col-xs-8">
				<ul class="top-nav nav-right">
					<li><a href="login_form.php"><i class="fa fa-lock" aria-hidden="true"></i>Login</a>
					</li>
					<li><a href="register.php"><i class="fa fa-user-plus" aria-hidden="true"></i>Signup</a>
					</li>
				</ul>
			</div>
		</div>
	...
	<div class="full-section search-section">
		<div class="search-area container">
			...
			<p class="search-tag-line">If you have search any question you can write or enter what you are looking for!</p>
                        <form autocomplete="off" method="get" class="search-form clearfix" id="search-form" action="Check.php">
...
<!-- Mirrored from templates.scriptsbundle.com/knowledge/demo/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Feb 2019 07:34:51 GMT -->
</html>